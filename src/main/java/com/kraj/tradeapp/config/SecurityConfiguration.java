...
import com.kraj.tradeapp.security.*;
import com.kraj.tradeapp.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/v1/twiml/voice/**")).permitAll()
                    ...
                    .requestMatchers(mvc.pattern("/api/v1/notifications/sql_ohlc/**")).permitAll()
